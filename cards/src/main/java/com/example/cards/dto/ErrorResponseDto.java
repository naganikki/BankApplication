...
public class ErrorResponseDto {
	...
	@Schema(
			description = "displays client path"
			)
	private String apiPath;
	@Schema(
			description = "displays HttpStatus error"
			)
	private HttpStatus errorCode;
	@Schema(
			description = "displays HttpStatus error message"
			)
	private String errorMsg;
	@Schema(
			description = "displays  error time"
			)
